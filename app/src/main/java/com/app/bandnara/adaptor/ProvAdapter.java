...
public class ProvAdapter extends BaseAdapter {
    ...
    Context context;
    List<ProvincesModel> itemString;
    LayoutInflater inflter;

    public ProvAdapter(Context applicationContext, List<ProvincesModel> itemString) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        ProvincesModel provincesModel = itemString.get(i);
        names.setText(provincesModel.getProvName());
        if(i==0){
