...
public class DeformData {
    ...
    private String typeDefom;

    private String getBeforeName3;
    ...
    public String getBeforeName2() {
        return beforeName2;
    }

    public void setBeforeName2(String beforeName2) {
    ...
    public void setStanapap(String stanapap) {
    ...
    public String getTypeDefom() {
        return typeDefom;
    }

    public void setTypeDefom(String typeDefom) {
        this.typeDefom = typeDefom;
    }

    public String getGetBeforeName3() {
        return getBeforeName3;
    }

    public void setGetBeforeName3(String getBeforeName3) {
        this.getBeforeName3 = getBeforeName3;
    }
